                ...
                Row {
                    ...
                    Button {
                        ...
                        onClicked: {
                            ...
                            fifthCompressWavePage.visible = false
                        }
                    }
                    Button {
                        text: qsTr("压缩波")
                        background: Rectangle{
                            //radius: buttonShear.radius
                            color: "peru"
                        }
...
/*
    ...
    InputPanel {
        ...
        x: fifthCompressWave.x
        y: fifthCompressWave.height

        width:fifthCompressWave.width - 100
        visible: false
